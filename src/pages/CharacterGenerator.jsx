  ...
  return (
    <div className="addCharacter">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="campaign" onChange={(e) => handleChange(e)} />
        ...
        <select type="text" name="hairColor" onChange={(e) => handleChange(e)}>
        ...
        <select type="text" name="hairStyle" onChange={(e) => handleChange(e)}>
        ...
        <select type="text" name="skinColor" onChange={(e) => handleChange(e)}>
        ...
        <select type="text" name="background" onChange={(e) => handleChange(e)}>
